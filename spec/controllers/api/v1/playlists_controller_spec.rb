...
describe Api::V1::PlaylistsController, type: :controller do
  ...
  describe "GET #index" do
   ...
   #    expect(json_response.first.slice(:user_id)).to eq [user_id: current_user]
   #
   # end
  ...
  describe "POST #create" do
    context "when is successfully created" do
      ...
      it "renders json when playlist created" do
        expect(json_response.slice(:title)).to eql title: @playlist.title
      end
    ...
    context "when is not created" do
      ...
      it "renders an error when the playlist could nto be created" do
        expect(json_response[:errors][:title]).to include "cant be blank"
      end
  ...
  describe "PUT/PATCH #update" do
    ...
    context "when is successfully updated" do
      it "renders the json representation for the updated playlist" do
        ...
        playlist_response= json_response[:playlist]
